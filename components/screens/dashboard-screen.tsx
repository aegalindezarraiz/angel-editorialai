...
export function DashboardScreen({ activeMissions, pipelineSnapshot, trendSignals }: DashboardScreenProps) {
  return (
    <div>
      <PageHeader
        title="Dashboard"
      ...
      <div className="card-grid">
        ...
        <div className="card span-12">
          ...
          <PipelineStageBoard stages={pipelineSnapshot} />
        </div>
      </div>
    </div>
  );
